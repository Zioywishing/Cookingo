import { AdminUserStatus, type AdminUserStatus as AdminUserStatusValue } from "~~/shared/admin/domain"
...
export const ADMIN_SUCCESS_RESPONSE_CODE = 0
export const ADMIN_SUCCESS_RESPONSE_MESSAGE = "success"
...
export const ADMIN_USER_STATUS_VALUES = Object.values(AdminUserStatus) as readonly AdminUserStatusValue[]

export const AdminLoginResult = {
  Success: "success",
  Failure: "failure",
} as const
export type AdminLoginResultValue = (typeof AdminLoginResult)[keyof typeof AdminLoginResult]

export const AdminLoginReason = {
  BadCredentials: "bad_credentials",
  Disabled: "disabled",
} as const
export type AdminLoginReasonValue = (typeof AdminLoginReason)[keyof typeof AdminLoginReason]
